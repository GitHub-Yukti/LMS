...
using LMS.Models.TokenAuth;
using LMS.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace LMS.Web.Tests
{
    public abstract class LMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LMSWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<LMSDbContext> action)
        {
            using (var context = IocManager.Resolve<LMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
